...
export interface V3Env { ADMIN_ORIGIN:string; SESSION_SECRET:string; AUTH_TOKEN_SECRET?:string; AUTH_TOKEN_SECRET_PREVIOUS?:string; AUTH_TOKEN_ALLOW_LEGACY_SESSION_SECRET?:string; PATIENT_IDENTITY_V2_ENABLED?:string; PATIENT_SELF_REGISTRATION_ENABLED?:string; PATIENT_SMS_OTP_ENABLED?:string; PATIENT_RECORD_LINKING_ENABLED?:string; PATIENT_IDENTITY_LOOKUP_SECRET?:string; CLINICAL_DATA_MASTER_KEY?:string; GLYMIZE_DB?:D1Database; PATIENT_PORTAL_V1_ENABLED?:string; PORTAL_MEDIA?:R2Bucket; [key:string]:unknown }
