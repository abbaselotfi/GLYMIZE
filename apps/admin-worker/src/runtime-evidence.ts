...
const SOURCES: Source[] = [
  ...
  { sourceId:"US-LABEL-REZDIFFRA-2026-07", shortCode:"REZDIFFRA PI 2026-07", title:"REZDIFFRA (resmetirom) tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=e67ea09f-a840-439c-86c8-f98585f978b2", activeVersion:"DailyMed updated 2026-07-31", engineDomains:["masld_mash","fibrosis_f2_f3","resmetirom","weight_tiered_dose","cyp2c8","statin_interaction","monitoring"], engineRoleFa:"دوز دقیق resmetirom بر اساس وزن، تعدیل با مهارکننده متوسط CYP2C8، محدودیت تداخل statin و مرز noncirrhotic F2-F3", engineRoleEn:"Exact resmetirom weight-tiered dosing, moderate-CYP2C8 dose modification, statin interaction limits, and the noncirrhotic F2-F3 boundary" },
  ...
  { sourceId:"US-LABEL-WEGOVY-2026-06", shortCode:"WEGOVY PI 2026-06", title:"WEGOVY (semaglutide) injection/tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=ee06186f-2aa3-4990-a760-757579d8f77b", activeVersion:"DailyMed effective 2026-06-18 / SPL version 19", engineDomains:["masld_mash","fibrosis_f2_f3","semaglutide","wegovy","dose_escalation","glp1_safety","monitoring"], engineRoleFa:"اندیکاسیون و دوز محصولی WEGOVY برای MASH غیرسیروتیک F2-F3، escalation هفتگی و contraindication/warningهای اختصاصی label", engineRoleEn:"Product-specific WEGOVY indication and dosing for noncirrhotic F2-F3 MASH, weekly escalation, and label-specific contraindication/warning boundaries" },
  { sourceId:"US-LABEL-ENALAPRIL-2026", shortCode:"ENALAPRIL PI 2026", title:"Enalapril maleate tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://www.dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=63187a94-9ac7-4320-ac70-0631e08c2b8d", activeVersion:"DailyMed revised 06/2026", engineDomains:["hypertension","heart_failure","crcl","renal_dose","enalapril"], engineRoleFa:"دوز شروع و تنظیم کلیوی انالاپریل بر اساس CrCl و مسیر نارسایی قلبی", engineRoleEn:"Enalapril initiation and renal dose adjustment by CrCl, plus heart-failure dosing" },
  { sourceId:"US-LABEL-LOSARTAN-2026", shortCode:"LOSARTAN PI 2026", title:"Losartan potassium tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://www.dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=e5886220-43b7-46e1-9034-5242ba245bd1", activeVersion:"DailyMed updated 2026-01-13", engineDomains:["hypertension","ckd","raas","losartan"], engineRoleFa:"دوز محصولی losartan، پایش کلیه/پتاسیم و محدودیت‌های برچسب", engineRoleEn:"Losartan product dosing, renal/potassium monitoring, and label constraints" },
  { sourceId:"US-LABEL-VALSARTAN-2026", shortCode:"VALSARTAN PI 2026", title:"Valsartan tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=04b3c573-4ef7-5cf6-e063-6294a90a2c5f", activeVersion:"DailyMed revised 06/2026", engineDomains:["hypertension","heart_failure","raas","valsartan"], engineRoleFa:"دوز شروع valsartan در فشارخون و نارسایی قلبی و پایش کلیه/پتاسیم", engineRoleEn:"Valsartan initiation in hypertension and heart failure with renal/potassium monitoring" },
  { sourceId:"US-LABEL-SPIRONOLACTONE-2026", shortCode:"SPIRONOLACTONE PI 2026", title:"Spironolactone tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=b119ed8a-289a-46c5-9778-6b07e4c061c4", activeVersion:"DailyMed updated 2026-06-01", engineDomains:["heart_failure","mra","egfr","potassium","spironolactone"], engineRoleFa:"دوز MRA در HFrEF با شاخه‌های eGFR و پتاسیم", engineRoleEn:"MRA dosing in HFrEF with eGFR and potassium branches" },
  { sourceId:"US-LABEL-KERENDIA-2025", shortCode:"KERENDIA PI 2025", title:"Kerendia (finerenone) — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=fc726765-5d5a-4d6e-b037-b847bda9fb7c", activeVersion:"DailyMed updated 2025-08-28", engineDomains:["ckd","albuminuria","finerenone","egfr","potassium"], engineRoleFa:"دوز شروع finerenone بر اساس eGFR و پتاسیم و پایش چهار هفته‌ای", engineRoleEn:"Finerenone initiation by eGFR and potassium with four-week monitoring" },
  { sourceId:"US-LABEL-ATORVASTATIN-2026", shortCode:"ATORVASTATIN PI 2026", title:"Atorvastatin calcium tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=0e24e7cb-1949-6686-e063-6394a90a4760", activeVersion:"DailyMed updated 2026-03-06", engineDomains:["lipids","ascvd","statin","atorvastatin"], engineRoleFa:"دوز شروع و محدوده دوز atorvastatin و پایش پاسخ LDL-C", engineRoleEn:"Atorvastatin initiation, dose range, and LDL-C response monitoring" },
  { sourceId:"US-LABEL-ROSUVASTATIN-2026", shortCode:"ROSUVASTATIN PI 2026", title:"Rosuvastatin tablets — U.S. prescribing information", sourceKind:"regulatory", sourceUrl:"https://www.dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=5c992d3d-d754-48b6-a267-1451208352ed", activeVersion:"DailyMed updated 2026-09-01", engineDomains:["lipids","ascvd","statin","crcl","renal_dose","rosuvastatin"], engineRoleFa:"دوز rosuvastatin و محدودیت صریح CrCl کمتر از ۳۰ در نارسایی شدید کلیه", engineRoleEn:"Rosuvastatin dosing with explicit severe-renal CrCl <30 limit" },
];
...
const RULES: Rule[] = [
  ...
  { id:"T2-LIVER-001", domain:"masld_mash", descriptionFa:"MASLD/MASH مرحله فیبروز و سیروز را وارد تصمیم می‌کند؛ pharmacotherapy محصولی فقط از مسیر label تاییدشده resmetirom یا WEGOVY اجرا می‌شود.", descriptionEn:"MASLD/MASH introduces fibrosis stage and cirrhosis into decision support; product pharmacotherapy executes only through reviewed resmetirom or WEGOVY label pathways.", sourceIds:["ada-2026","easl-masld-2024","aasld-resmetirom-2024","US-LABEL-REZDIFFRA-2026-07","aasld-semaglutide-mash-2025","US-LABEL-WEGOVY-2026-06"], engineEffect:"ranking_and_safety:liver" },
  { id:"T2-LIVER-002", domain:"resmetirom", descriptionFa:"Resmetirom فقط در MASH غیرسیروتیک F2–F3 اجرا می‌شود؛ دوز و تداخلات باید از برچسب جاری REZDIFFRA حل شوند.", descriptionEn:"Resmetirom executes only in non-cirrhotic MASH F2-F3; dose and interaction handling are resolved from the current REZDIFFRA label.", sourceIds:["easl-masld-2024","ema-resmetirom-2025","aasld-resmetirom-2024","US-LABEL-REZDIFFRA-2026-07"], engineEffect:"eligibility_and_label_dose:resmetirom" },
...
const ALIASES: Record<string,string[]> = {
  ...
  mash:["masld","liver","fibrosis","wegovy","semaglutide","resmetirom","کبد","فیبروز"],
  masld:["mash","liver","fibrosis","wegovy","semaglutide","resmetirom","کبد","فیبروز"],
  کبد:["liver","masld","mash","fibrosis","wegovy","semaglutide"],
  ...
  resmetirom:["mash","fibrosis","f2","f3","rezdiffra","dose","دوز"],
  wegovy:["semaglutide","mash","masld","f2","f3","dose","dosage","titration","دوز","تیتراسیون"],
  semaglutide:["wegovy","mash","masld","glp1","دوز"],
  دوز:["dose","dosage","titration","wegovy","resmetirom"],
  تیتراسیون:["titration","dose","wegovy","semaglutide"],
};
