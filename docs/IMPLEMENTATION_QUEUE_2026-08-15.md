...
6. Complete Patient Record v2 schema/contracts and runtime adapter, including stable Patient ≠ Encounter semantics, national-ID-default smart lookup, practice monotonic file-number allocator/high-water mark, encrypted patient/encounter physician-note revisions, then perform RC-only migration rehearsal.
