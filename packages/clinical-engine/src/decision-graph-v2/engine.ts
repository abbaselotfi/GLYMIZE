...
export function runDecisionGraphV2(
  ...
  if (request.patient.glycemia.ketonesKnownPositive || (clinicalState.severeHyperglycemia && request.patient.glycemia.catabolicFeatures)) status = "urgent_clinician_review";
