...
export const clinicalDomainCapabilities: readonly ClinicalDomainCapability[] = [
  ...
  },
  {
    ...
    nextGap: "Represent weekly current-medication intervals and multi-step titration cost phases before enabling WEGOVY continuation/cost execution, then proceed to the painful-neuropathy completeness gap.",
  },
  {
    domain: "neuropathy",
