...
export const clinicalDomainCapabilities: readonly ClinicalDomainCapability[] = [
  ...
  },
  {
    ...
    evidenceAuthorities: ["EASL-EASD-EASO MASLD 2024", "AASLD resmetirom 2024", "REZDIFFRA current regulatory label", "AASLD semaglutide MASH 2025"],
    boundary: "The liver lane is executable only for explicitly protocolized products and phenotypes; resmetirom is currently the first executable F2-F3 noncirrhotic MASH product.",
    nextGap: "Add the current Wegovy/semaglutide MASH protocol with exact escalation, contraindication and GLP-1 duplication handling; other liver medicines remain review-only.",
  },
  {
    domain: "obesity",
    executionState: "partially_executable",
  ...
  },
  {
    ...
    decisionGraphLanes: ["liver"],
    executableObjectives: ["liver_directed_therapy"],
    minimumSafeInputs: ["adult status", "confirmed MASH", "F2/F3 fibrosis", "explicit noncirrhotic state", "actual body weight", "current medication interactions"],
    evidenceAuthorities: ["EASL-EASD-EASO MASLD 2024", "AASLD resmetirom 2024", "REZDIFFRA current regulatory label", "AASLD semaglutide MASH 2025", "current Wegovy regulatory label"],
    boundary: "Resmetirom is executable only for the reviewed adult F2-F3 noncirrhotic phenotype after interaction and Iran-market gates pass; other MASH products remain non-executable until separately protocolized.",
    nextGap: "Implement semaglutide/Wegovy MASH execution with label-derived 4-week escalation, maintenance-dose handling, contraindication and GLP-1 duplication gates.",
  },
  {
    domain: "neuropathy",
