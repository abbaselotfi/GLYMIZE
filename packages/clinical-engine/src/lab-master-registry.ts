...
export const LAB_MASTER_REGISTRY: readonly LabMasterEntry[] = [
  ...
  { canonicalKey: "fbs", name: "Fasting glucose", faName: "قند خون ناشتا", category: "glycemic", specimens: ["serum_plasma"], valueKind: "quantitative", defaultUnit: "mg/dL", allowedUnits: ["mg/dL", "mmol/L"], aliases: ["Fasting glucose", "قند خون ناشتا", "FBS", "FBG", "Fasting blood sugar", "Fasting blood glucose", "قند ناشتا", "گلوکز ناشتا"] },
  ...
  { canonicalKey: "vitamin_d_25oh", name: "25-OH Vitamin D", faName: "ویتامین D 25-OH", category: "vitamins", specimens: ["serum_plasma"], valueKind: "quantitative", defaultUnit: "ng/mL", allowedUnits: ["ng/mL", "nmol/L"], aliases: ["25-OH Vitamin D", "ویتامین D 25-OH", "25 hydroxy vitamin D", "25(OH)D", "25(OH) Vitamin D", "25(OH) Vitamin D3", "Vitamin D3", "Vitamin D", "ویتامین D"] },
